...
<script>
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.edit == true) {
                        ...
                        tbl.find(` tr:eq(${trInd}) td:eq(1) `).text(city.find('option:selected').text());
                        tbl.find(` tr:eq(${trInd}) td:eq(1) `).data('id', city.val());
                        ...
                        tbl.find(` tr:eq(${trInd}) td:eq(6) img`).attr('src', '../img-box/' + photo.val());
                        tbl.find(` tr:eq(${trInd}) td:eq(6) img`).attr('alt', photo.val());
                        $('#txt-edit-id').val(0);
                        $('#txt-id').val(lastId);
                    } else {
                        var tr = `
        ...
        tbl.on('click', 'tr td .btn-edit', function() {
            ...
            trInd = tr.index(); // get index of tr
